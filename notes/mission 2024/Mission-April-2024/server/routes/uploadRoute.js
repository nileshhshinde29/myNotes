...
const { uploadMultiImageImage, uploadSingleImage, uploadPDF, uploadImageUsingFS, downloadPdf, downloadJSONtoCsv, createPDF } = require('../controller/uploadController')
